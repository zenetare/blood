        ...
        <div class="col-12">
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Form new city ({{ $country->country }})</h3>
            </div>
            <!-- /.card-header -->
            <form id="quickForm" novalidate="novalidate" action="{{ aca_url('adminPanel/' . $country->id . '/city/create') }}" method="POST">
              @csrf
              <div class="card-body">
